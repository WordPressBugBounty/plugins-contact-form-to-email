...
?>
   <tr> 
    ...
    <td>
                             ...
                             <input style="margin-bottom:3px;" class="button" type="button" name="caladdbk_<?php echo intval($item->id); ?>" value="<?php _e('Add Message','contact-form-to-email'); ?>" onclick="cp_addbk(<?php echo intval($item->id); ?>);" />                             
...
<div id="metabox_basic_settings" class="postbox" >
    ...
    <label onclick="window.open('https://form2email.dwbooster.com/download');"for="addon-CFTEFlowCL-20230707" style="font-weight:bold;"><input type="checkbox" disabled id="addon-CFTEFlowCL-20230707" name="cfte_addons" value="addon-CFTEFlowCL-20230707">Flow.cl Payments Integration</label> <div style="font-style:italic;padding-left:20px;">The add-on adds support for Flow.cl payments</div>
    ...
    <label onclick="window.open('https://form2email.dwbooster.com/download');" for="addon-TURNSTILE-20151106" style="font-weight:bold;"><input type="checkbox" disabled id="addon-turnstile-20151106" name="cfte_addons" value="addon-turnstile-20151106" >Cloudflare Turnstile</label> <div style="font-style:italic;padding-left:20px;">The add-on allows to protect the forms with Cloudflare Turnstile</div></div><div>
